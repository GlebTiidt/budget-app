...
function buildInstructions(): string {
  return [
    ...
    "Classify a purchase or payment for goods or services as expense unless the message explicitly describes a refund, income, debt, or personal transfer. Coffee, beer, takeaway drinks, snacks, groceries, and meals are expenses even when the user says they recorded them today for yesterday; words such as записал or записывал describe reporting the event, not receiving money.",
