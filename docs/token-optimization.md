...
The purchase-direction regression and prompt-cache `v6` were verified on 2026-09-01. All 14 parser cases and all four reply revisions passed with `reasoning: none`, including a new case where coffee, beer, and snacks recorded today for yesterday produced three expenses and zero income. Across 18 requests, the API reported 25,085 input tokens, 15,769 cached input tokens (`62.9%` of input), 1,213 cache-write tokens, 3,423 output tokens, zero reasoning tokens, and 28,508 total tokens.
